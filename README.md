...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/polished-fog-9d4b
```

A live public deployment of this template is available at [https://polished-fog-9d4b.templates.workers.dev](https://polished-fog-9d4b.templates.workers.dev)
